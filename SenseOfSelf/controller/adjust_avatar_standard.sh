...
# arm_lengthen.xmlの生成
cp ./arm_standard_src.xml ./arm_lengthen.xml
chmod 666 ./arm_lengthen.xml

sed -i -e "s/SCALEX/$body_scale/g" ./arm_lengthen.xml
sed -i -e "s/SCALEY/$body_scale/g" ./arm_lengthen.xml
sed -i -e "s/SCALEZ/$body_scale/g" ./arm_lengthen.xml
sed -i -e "s/X3DFILENAME/arm_lengthen/g" ./arm_lengthen.xml

# arm_lengthen.x3dの生成
cp ./arm_standard_src.x3d ./arm_lengthen.x3d
chmod 666 ./arm_lengthen.x3d

sed -i -e "s/HEAD_JOINT0_y/$HEAD_JOINT0_y/g"      ./arm_lengthen.x3d
sed -i -e "s/LARM_JOINT0_x/$LARM_JOINT0_x/g"      ./arm_lengthen.x3d
sed -i -e "s/LARM_JOINT0_y/$LARM_JOINT0_y/g"      ./arm_lengthen.x3d
sed -i -e "s/RARM_JOINT0_x/$RARM_JOINT0_x/g"      ./arm_lengthen.x3d
sed -i -e "s/RARM_JOINT0_y/$RARM_JOINT0_y/g"      ./arm_lengthen.x3d

sed -i -e "s/LARM_JOINT3_x/$LARM_JOINT3_LONG_x/g" ./arm_lengthen.x3d
sed -i -e "s/RARM_JOINT3_x/$RARM_JOINT3_LONG_x/g" ./arm_lengthen.x3d
sed -i -e "s/LARM_JOINT5_x/$LARM_JOINT5_LONG_x/g" ./arm_lengthen.x3d
sed -i -e "s/RARM_JOINT5_x/$RARM_JOINT5_LONG_x/g" ./arm_lengthen.x3d

sed -i -e "s/LARM_LINK2_x/$LARM_LINK2_LONG_x/g"   ./arm_lengthen.x3d
sed -i -e "s/RARM_LINK2_x/$RARM_LINK2_LONG_x/g"   ./arm_lengthen.x3d
sed -i -e "s/ARM_LINK4_LEN/$ARM_LINK4_LONG_LEN/g" ./arm_lengthen.x3d
sed -i -e "s/LARM_LINK4_x/$LARM_LINK4_LONG_x/g"   ./arm_lengthen.x3d
sed -i -e "s/RARM_LINK4_x/$RARM_LINK4_LONG_x/g"   ./arm_lengthen.x3d


# arm_cut.xmlの生成
cp ./arm_standard_src.xml ./arm_cut.xml
chmod 666 ./arm_cut.xml

sed -i -e "s/SCALEX/$body_scale/g" ./arm_cut.xml
sed -i -e "s/SCALEY/$body_scale/g" ./arm_cut.xml
sed -i -e "s/SCALEZ/$body_scale/g" ./arm_cut.xml
sed -i -e "s/X3DFILENAME/arm_cut/g" ./arm_cut.xml

# arm_cut.x3dの生成
cp ./arm_standard_src.x3d ./arm_cut.x3d
chmod 666 ./arm_cut.x3d

sed -i -e "s/HEAD_JOINT0_y/$HEAD_JOINT0_y/g"       ./arm_cut.x3d
sed -i -e "s/LARM_JOINT0_x/$LARM_JOINT0_x/g"       ./arm_cut.x3d
sed -i -e "s/LARM_JOINT0_y/$LARM_JOINT0_y/g"       ./arm_cut.x3d
sed -i -e "s/RARM_JOINT0_x/$RARM_JOINT0_x/g"       ./arm_cut.x3d
sed -i -e "s/RARM_JOINT0_y/$RARM_JOINT0_y/g"       ./arm_cut.x3d

sed -i -e "s/LARM_JOINT3_x/$LARM_JOINT3_SHORT_x/g" ./arm_cut.x3d
sed -i -e "s/RARM_JOINT3_x/$RARM_JOINT3_SHORT_x/g" ./arm_cut.x3d
sed -i -e "s/LARM_JOINT5_x/$LARM_JOINT5_SHORT_x/g" ./arm_cut.x3d
sed -i -e "s/RARM_JOINT5_x/$RARM_JOINT5_SHORT_x/g" ./arm_cut.x3d

sed -i -e "s/LARM_LINK2_x/$LARM_LINK2_SHORT_x/g"   ./arm_cut.x3d
sed -i -e "s/RARM_LINK2_x/$RARM_LINK2_SHORT_x/g"   ./arm_cut.x3d
sed -i -e "s/ARM_LINK4_LEN/$ARM_LINK4_SHORT_LEN/g" ./arm_cut.x3d
sed -i -e "s/LARM_LINK4_x/$LARM_LINK4_SHORT_x/g"   ./arm_cut.x3d
sed -i -e "s/RARM_LINK4_x/$RARM_LINK4_SHORT_x/g"   ./arm_cut.x3d
