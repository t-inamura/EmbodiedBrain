/*==================================================================
	OptiTrackをVC++2010から使うためのサンプルコード．
	基本的には，
	NatNet_SDK_2.7\NatNetSDK\Samples\SampleClient\SampleClient.cpp
	をコピーしました．
  ==================================================================*/
...
//
//// int _tmain(int argc, _TCHAR* argv[]) // プリコンパイル済みヘッダを使うときはこちら
//int main(int argc, char* argv[]) // 空のプロジェクトから作成するときはこちら
//{
//
//    int iResult;
