...
　　　　フォルダを設定し直す．例えば，「$(SolutionDir)$(Configuration)_2010\」を
	...
	(5) 以上の状態で，「SIGService」のプロジェクトをビルドする．
　　(6) KinectV2_vs2013.slnのビルド時に，(5)で生成したSIGService.libをリンクする．
