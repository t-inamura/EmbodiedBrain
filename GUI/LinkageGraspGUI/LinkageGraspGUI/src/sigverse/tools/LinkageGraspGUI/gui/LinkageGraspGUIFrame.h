...
#ifndef SIGVERSE_MIRROR_THERAPY_GUI_GUI_FRAME
#define SIGVERSE_MIRROR_THERAPY_GUI_GUI_FRAME
...
class MainFrame : public wxFrame 
{
	...
	protected:
		...
		virtual void OnLinkageGraspClick( wxCommandEvent& event ) { event.Skip(); }
...
#endif // SIGVERSE_MIRROR_THERAPY_GUI_GUI_FRAME
