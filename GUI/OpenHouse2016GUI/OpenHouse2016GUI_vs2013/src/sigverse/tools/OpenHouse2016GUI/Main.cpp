 ...
 * ＜その他＞
 * ・設定ファイル名は、config.ini
 * ・GUIの設計には、wxFormBuilderを使用している（OpenHouse2016GUI.hとOpenHouse2016GUI.cppはwxFormBuilderにより生成している）
 */
...
const std::string Param::PARAM_FILE_NAME = "OpenHouse2016GUI.ini";
...
bool MainApp::OnInit()
{
	...
	OpenHouse2016GUIMainFrame *frame = new OpenHouse2016GUIMainFrame(NULL, wxGetApp().argc, wxGetApp().argv.GetArguments());
